...
export function Pricing() {
  ...
  const tiers: Tier[] = [
    ...
    { key: "standard", price: "€129.99", features: [t("tier_standard_f1"), t("tier_standard_f2")] },
    {
      ...
      note: t("tier_onestop_note"),
    },
    { key: "ep", price: "€649.99", features: [t("tier_ep_f1"), t("tier_ep_f2")], note: t("tier_note_songs") },
    { key: "album", price: "€1,299.99", features: [t("tier_album_f1"), t("tier_album_f2")], note: t("tier_note_songs") },
  ];
  ...
  return (
    <section id="pricing" className="border-t border-border py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="no-scrollbar mt-14 -mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto px-5 pb-4 pt-4 sm:mx-0 sm:px-0 lg:grid lg:grid-cols-5 lg:overflow-visible lg:pb-0 lg:pt-0">
          {tiers.map((tier, i) => (
            <Reveal key={tier.key} delay={i * 0.05} className="w-[78%] shrink-0 snap-center sm:w-[46%] md:w-[32%] lg:w-auto lg:shrink">
              ...
              >
                ...
                {tier.note && (
                  <p className={cn("mt-5 text-[12px] italic leading-relaxed", tier.featured ? "text-ink-dim" : "text-ink-faint")}>
                    {tier.note}
                  </p>
                )}
                ...
                >
                  {t("pricing_book")} {t(`tier_${tier.key}_name`)}
                </a>
              </div>
            </Reveal>
          ))}
